...
public class ExplicitWaitStepDefinitions {
    ...
    public void user_waits_until_the_page_loads() {
        ...
        wait.until(ExpectedConditions.visibilityOf(Driver.getDriver().findElement(By.xpath("//*[.='Hello World!']"))));
    }

    @Then("verify the Hello World! text is visible")
    public void verify_the_Hello_World_text_is_visible() {
        Assert.assertTrue(Driver.getDriver().findElement(By.xpath("//*[.='Hello World!']")).getText().equals("Hello World!"));
    }
    @Given("user fluently waits until the page loads and verify the text message")
    public void user_fluently_waits_until_the_page_loads_and_verify_the_text_message() {
